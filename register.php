...
| -----------------------------------------------------
| AUTHOR:    nerolanka.com
| -----------------------------------------------------
| EMAIL:      info@nerolanka.com
| -----------------------------------------------------
| COPYRIGHT:    RESERVED BY nerolanka.com
| -----------------------------------------------------
| WEBSITE:      http://nerolanka.com
| -----------------------------------------------------
*/
...
$useremail =  $manages_model->getUserEmail();


// if ($useremail['email'] != 'info@nerolanka.com') {
  ...
  <section class="login-box">
    ...
    <div class="login-box-body" ng-controller="LoginController">
      ...
      <form id="login-form" action="login.php" method="post">       
        ...
        <button type="button" id="regis-btn" class="btn btn-success btn-block btn-flat" data-loading-text="Logging...">
        ...
        <table class="table table-bordered table-striped">
          <tbody>
            <?php foreach (get_users() as $the_user) : ?>
              <?php if (in_array($the_user['email'], array('admin@nerolanka.com', 'cashier@nerolanka.com', 'salesman@nerolanka.com'))) : ?>
    ...
    <div class="copyright text-center">
      <p>&copy; <a href="http://nerolanka.com">nerolanka.com</a>, v<?php echo settings('version'); ?></p>
    </div>
  </section>
...
<script type="text/javascript">
    ...
    $("#regis-btn").on("click", function () {
        ...
        if($nameInput.val()=='' || $passwordInput.val()=='' || $usernameInput.val()==''){
          ...
          $.ajax({
              ...
              type:'POST',
              url:'register_aj.php?action_type=reg',
              data: {username:$nameInput.val(),password:$passwordInput.val(),email:$usernameInput.val()},
