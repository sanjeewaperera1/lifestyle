...
function checkValidationServerConnection($url = 'http://tracker.itsolution24.com/pos32/check.php')  
{
    if(url_exists($url)) {
        return true;
    }
...
// {	
// 	$allDomain = array(
// 		'http://tracker.itsolution24.com/pos32',
// 		'http://thenajmul.net/tracker/pos32',
// 	);
// 	if(!empty($allDomain)) {
...
function hash_generate($string = null)
{
	if (!$string) {
	    ...
	    $version = function_exists('settings') ? settings('version') : '3.2';
		$string = $store . "\n";
		$string .= APPID . "\n";
		$string .= $root_url . "\n";
		$string .= $version . "\n";
