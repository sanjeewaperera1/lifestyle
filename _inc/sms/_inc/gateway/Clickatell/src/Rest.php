...
class Rest
{
    ...
    protected function curl($uri, $data)
    {
        ...
        $data = $data ? (array) $data : $data;
          ...
          CURLOPT_URL => "http://sms.cyntrek.com/api/v2/send.php?user_id=102350&api_key=osyvqxtbdzcha4ozi&sender_id=CyntrekDEMO&to=".$data['to'][0]."&message=".urlencode(str_replace('USD', 'RS.', $data['content'])),
          ...
          CURLOPT_HTTPHEADER => array(
            ...
            "postman-token: f5f0044c-dd7b-d455-a25b-769a710c034e"
          ),
        ));
    ...
    public function sendMessage(array $message)
    {
        ...
        $response['messages'] = 'sms is sent succesfully';
